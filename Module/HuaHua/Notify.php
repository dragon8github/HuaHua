...
require_once    $_SESSION["APP_ROOT"]."/Lib/wang/wxpay/lib/WxPay.Api.php";
require_once    $_SESSION["APP_ROOT"]."/Lib/wang/wxpay/lib/WxPay.Notify.php";

...
require_once "wxpay/lib/WxPay.Api.php";    //用户充值
require_once "wxpay/example/WxPay.JsApiPay.php";//用户充值
require_once 'wxpay/example/log.php';

require_once "wxpay/api_test.php";  //用户提现
class WX_INT  
{  
   ...
   //获取用户头像 名称等信息
	...
	public function Jspay($body,$attach,$total_fee,$Notify_url,$openId)
	{	
		$tools = new JsApiPay();
	...
	public function Zhifu($amount,$openid)
	{
			...
			$data="<xml>
					...
					$zs1="wxpay/cert/apiclient_cert.pem";
					$zs2="wxpay/cert/apiclient_key.pem";
